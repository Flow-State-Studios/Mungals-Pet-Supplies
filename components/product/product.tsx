...
import ProductSizeOptions from '../form/product-size-options';
import ProductColorOptions from '../form/product-color-options';
...
const Product = async ({product}: {product: any}) => {
    ...
    return <form className={`${styles.featured_product}`}>  
            ...
            <div className={`${styles.product_info}`}>
...

                {
                    ...
                    ?  <ProductSizeOptions product_id={product.product_id} variation_size={product.size} available_sizes={base_product.sizes}/>
                    : null
                }

                {
                    product.available_colors.length > 0 
                    ? <ProductColorOptions product_id={product.product_id} variation_color={product.color} available_colors={product.available_colors}/>
                    : null
                }
